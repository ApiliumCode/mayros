## Mayros Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_mayros-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm mayros gateway --port 18789 --verbose
```
