...
final class NetworkStatusService: @unchecked Sendable {
    ...
    private static func payload(from path: NWPath) -> MayrosNetworkStatusPayload {
        let status: MayrosNetworkPathStatus = switch path.status {
    ...
    private static func fallbackPayload() -> MayrosNetworkStatusPayload {
        MayrosNetworkStatusPayload(
            status: .unsatisfied,
            isExpensive: false,
            isConstrained: false,
            interfaces: [.other])
