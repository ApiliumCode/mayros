...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MayrosPhotosLatestParams) async throws -> MayrosPhotosLatestPayload {
        ...
        var results: [MayrosPhotoPayload] = []
        ...
        return MayrosPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MayrosPhotoPayload
    {
