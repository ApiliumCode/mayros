...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.mayros.gateway"
    private static let nodeService = "ai.mayros.node"
    private static let talkService = "ai.mayros.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.mayros.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.mayros.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("mayros-gateway.log")
    }
