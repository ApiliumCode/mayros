...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Mayros token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: MayrosOAuthStore.AnthropicOAuthStatus = MayrosOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.mayros", category: "anthropic-oauth")
...
enum MayrosOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let mayrosOAuthDirEnv = "MAYROS_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Mayros OAuth token file not found"
            case .unreadableFile: "Mayros OAuth token file not readable"
            case .invalidJSON: "Mayros OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Mayros OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Mayros OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.mayrosOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".mayros", isDirectory: true)
