...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.mayros", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Mayros/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__mayros__/a2ui/").absoluteString + "?platform=macos"
    }
