...
enum UIStrings {
    static let welcomeTitle = "Welcome to Mayros"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "mayros.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: MayrosOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: MayrosChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g mayros@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MayrosChatViewModel(
