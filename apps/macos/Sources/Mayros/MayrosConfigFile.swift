...
enum MayrosConfigFile {
    private static let logger = Logger(subsystem: "ai.mayros", category: "config")
    ...
    static func stateDirURL() -> URL {
        MayrosPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        MayrosPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-mayros-config-file",
            "event": "config.write",
