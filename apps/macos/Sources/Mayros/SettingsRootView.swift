...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .mayrosSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MayrosPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MayrosPaths.stateDirURL.path
...
extension Notification.Name {
    static let mayrosSelectSettingsTab = Notification.Name("mayrosSelectSettingsTab")
}
