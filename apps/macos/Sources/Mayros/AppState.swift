...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MayrosConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MayrosConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = MayrosConfigFile.loadDict()
            ...
            MayrosConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/mayros"
        state.remoteCliPath = ""
        return state
    }
}
