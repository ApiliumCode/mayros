...
final class InstancesStore {
    ...
    private let logger = Logger(subsystem: "ai.mayros", category: "instances")
    ...
    func handlePresenceEventPayload(_ payload: MayrosProtocol.AnyCodable) {
        do {
...
extension InstancesStore {
    static func preview(instances: [InstanceInfo] = [
        InstanceInfo(
            ...
            mode: "local",
            reason: "preview",
            text: "Local node: atlas-node (10.0.0.12) · app 1.2.3",
