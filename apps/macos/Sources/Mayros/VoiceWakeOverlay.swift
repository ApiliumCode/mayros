...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.mayros", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Mayros windows, but below the system’s pop-up menus.
