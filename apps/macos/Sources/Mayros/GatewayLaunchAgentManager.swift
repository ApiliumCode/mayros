...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.mayros", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".mayros/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.mayrosCommand(
            subcommand: "gateway",
