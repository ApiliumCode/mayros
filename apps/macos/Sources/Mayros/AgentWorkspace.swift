...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.mayros", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MayrosConfigFile.defaultWorkspaceURL() }
