...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/ApiliumCode/mayros") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/ApiliumCode/mayros")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://mayros.ai")
                AboutLinkRow(icon: "bird", title: "Twitter", url: "https://twitter.com/ApiliumCode")
                AboutLinkRow(icon: "envelope", title: "Email", url: "mailto:contact@apilium.com")
            }
            ...
            Text("© 2026 Apilium Technologies — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "MayrosBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MayrosBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MayrosGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MayrosGitCommit") as? String) ??
            "unknown"
    }
