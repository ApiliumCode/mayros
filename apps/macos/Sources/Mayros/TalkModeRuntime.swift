...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.mayros", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.mayros", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MayrosChatMessage] = messages.compactMap { item in
