...
@MainActor
public struct MayrosChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: MayrosChatViewModel
    ...
    private var visibleMessages: [MayrosChatMessage] {
        let base: [MayrosChatMessage]
    ...
    private func mergeToolResults(in messages: [MayrosChatMessage]) -> [MayrosChatMessage] {
    ...
    private func isToolResultMessage(_ message: MayrosChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: MayrosChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: MayrosChatMessage) -> String {
