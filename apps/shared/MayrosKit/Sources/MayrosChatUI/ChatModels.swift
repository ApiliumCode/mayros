...
public typealias MayrosPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MayrosPlatformImage = UIImage
#endif

public struct MayrosChatUsageCost: Codable, Hashable, Sendable {
...
public struct MayrosChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MayrosChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MayrosChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MayrosChatMessageContent: Codable, Hashable, Sendable {
...
public struct MayrosChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MayrosChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MayrosChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MayrosChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MayrosChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MayrosChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MayrosChatMessageContent].self, forKey: .content) {
...
public struct MayrosChatHistoryPayload: Codable, Sendable {
...
public struct MayrosSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MayrosSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MayrosSessionPreviewItem]
}

public struct MayrosSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MayrosSessionPreviewEntry]

    public init(ts: Int, previews: [MayrosSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MayrosChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MayrosChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MayrosAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MayrosChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MayrosGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MayrosPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MayrosPlatformImage?
...
public struct MayrosChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
