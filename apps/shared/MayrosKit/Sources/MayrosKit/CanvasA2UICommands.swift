...
public enum MayrosCanvasA2UICommand: String, Codable, Sendable {
...
public struct MayrosCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MayrosCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
