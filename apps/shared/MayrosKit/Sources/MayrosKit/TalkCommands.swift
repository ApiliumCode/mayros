...
public enum MayrosTalkCommand: String, Codable, Sendable {
...
public struct MayrosTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MayrosTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
