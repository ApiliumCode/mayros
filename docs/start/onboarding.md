---
summary: "First-run onboarding flow for Mayros (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Mayros">
...
<Step title="CLI">
  ...
  The app can install the global `mayros` CLI via npm/pnpm so terminal
