---
summary: "Overview of Mayros onboarding options and flows"
read_when:
...
Mayros supports multiple onboarding paths depending on where the Gateway runs
...
- [`mayros onboard` command](/cli/onboard)

## macOS app onboarding

Use the Mayros app when you want a fully guided setup on macOS. Docs:
