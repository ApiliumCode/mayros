...
This guide summarizes a sane workflow for working on the pi integration in Mayros.
...
State lives under the Mayros state directory. Default is `~/.mayros`. If `MAYROS_STATE_DIR` is set, use that directory instead.

To reset everything:

- `mayros.json` for config
...
- [https://apilium.com/us/doc/mayros/testing](https://apilium.com/us/doc/mayros/testing)
- [https://apilium.com/us/doc/mayros/start/getting-started](https://apilium.com/us/doc/mayros/start/getting-started)
