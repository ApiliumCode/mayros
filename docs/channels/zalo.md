...
- Install via CLI: `mayros plugins install @apilium/mayros-zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `mayros plugins install ./extensions/zalo`
   - From npm (if published): `mayros plugins install @apilium/mayros-zalo`
...
- Approve via:
  - `mayros pairing list zalo`
  - `mayros pairing approve zalo <CODE>`
...
- Example: `mayros message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `mayros channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `mayros logs --follow`
