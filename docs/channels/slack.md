...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Mayros HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `mayros pairing approve slack <code>`.
...
Mayros supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Mayros falls back to normal delivery for remaining payloads.
