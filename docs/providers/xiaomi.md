---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Mayros"
read_when:
  - You want Xiaomi MiMo models in Mayros
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Mayros uses
