---
summary: "Use Qianfan's unified API to access many models in Mayros"
read_when:
...
3. Mayros installed on your system
...
4. Copy the API key for use with Mayros

## CLI setup

```bash
mayros onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Mayros Configuration](/gateway/configuration)
