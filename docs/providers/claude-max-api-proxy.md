...
You can point Mayros at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Mayros
...
- [Anthropic provider](/providers/anthropic) - Native Mayros integration with Claude setup-token or API keys
