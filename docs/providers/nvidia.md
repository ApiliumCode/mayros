---
summary: "Use NVIDIA's OpenAI-compatible API in Mayros"
read_when:
  - You want to use NVIDIA models in Mayros
...
mayros onboard --auth-choice skip
mayros models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
