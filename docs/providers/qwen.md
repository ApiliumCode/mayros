---
summary: "Use Qwen OAuth (free tier) in Mayros"
read_when:
  - You want to use Qwen with Mayros
...
If you already logged in with the Qwen Code CLI, Mayros will sync credentials
