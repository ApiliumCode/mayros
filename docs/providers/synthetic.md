---
summary: "Use Synthetic's Anthropic-compatible API in Mayros"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Mayros registers it as the
...
Note: Mayros's Anthropic client appends `/v1` to the base URL, so use
