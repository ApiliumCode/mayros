...
Deepgram is a speech-to-text API. In Mayros it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Mayros uploads the audio file to Deepgram and injects the transcript
