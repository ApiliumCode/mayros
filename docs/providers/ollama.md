---
summary: "Run Mayros with Ollama (local LLM runtime)"
read_when:
  - You want to run Mayros with local models via Ollama
...
3. Enable Ollama for Mayros (any value works; Ollama doesn't require a real key):
