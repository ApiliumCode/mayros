...
- For manual spawns, delivery is resilient:
  - Mayros tries direct `agent` delivery first with a stable idempotency key.
...
- Sub-agent context only injects `AGENTS.md` + `TOOLS.md` (no `MAYROS.md`, `IDENTITY.md`, `USER.md`, `HEARTBEAT.md`, or `BOOTSTRAP.md`).
