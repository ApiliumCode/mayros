...
Mayros ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Mayros also aligns
the install method:
...
When you switch channels with `mayros update`, Mayros also syncs plugin sources:
