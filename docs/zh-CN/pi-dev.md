...
本指南总结了在 Mayros 中开发 Pi 集成的合理工作流程。
...
状态存储在 Mayros 状态目录下。默认为 `~/.mayros`。如果设置了 `MAYROS_STATE_DIR`，则使用该目录。
...
- https://apilium.com/us/doc/mayros/testing
- https://apilium.com/us/doc/mayros/start/getting-started
