...
read_when:
  - You are building a Mayros plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (mayros.plugin.json)

Every plugin **must** ship a `mayros.plugin.json` file in the **plugin root**.
Mayros uses this manifest to validate configuration **without executing plugin
