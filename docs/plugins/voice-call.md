...
read_when:
  - You want to place an outbound voice call from Mayros
...
Voice calls for Mayros via a plugin. Supports outbound notifications and
...
- Use `mayros voicecall ...` or the `voice_call` tool
