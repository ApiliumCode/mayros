...
- **X/Twitter:** [@ApiliumCode](https://x.com/ApiliumCode) / [@mayros](https://x.com/mayros)

## Maintainers

- **Apilium Team** - Benevolent Dictator
  - GitHub: [@ApiliumCode](https://github.com/ApiliumCode) · X: [@ApiliumCode](https://x.com/ApiliumCode)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/ApiliumCode/mayros/discussions) or ask in Discord first
...
- **Skills**: For skill contributions, head to [Skills Hub](https://hub.apilium.com/) — the community hub for Mayros skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/ApiliumCode/mayros/issues) for "good first issue" labels!

## Maintainers

We're selectively expanding the maintainer team.
If you're an experienced contributor who wants to help shape Mayros's direction — whether through code, docs, or community — we'd like to hear from you.
