...
export function listBlueBubblesAccountIds(cfg: MayrosConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: MayrosConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: MayrosConfig): ResolvedBlueBubblesAccount[] {
