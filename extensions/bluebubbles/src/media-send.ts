...
import { resolveChannelMediaMaxBytes, type MayrosConfig } from "mayros/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: MayrosConfig; accountId?: string }): string[] {
