...
import type { ReplyPayload, MayrosConfig } from "mayros/plugin-sdk";
import { createReplyPrefixOptions } from "mayros/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as MayrosConfig;
