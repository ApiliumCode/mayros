...
Nostr DM channel plugin for Mayros using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Mayros. It enables your bot to:
...
# Configure mayros to use local relay
