...
export function listMattermostAccountIds(cfg: MayrosConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: MayrosConfig): string {
...
export function listEnabledMattermostAccounts(cfg: MayrosConfig): ResolvedMattermostAccount[] {
