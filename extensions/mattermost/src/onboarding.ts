import type { ChannelOnboardingAdapter, MayrosConfig, WizardPrompter } from "mayros/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://apilium.com/us/doc/mayros/channels/mattermost",
    ].join("\n"),
