import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "mayros/plugin-sdk";
import { addWildcardAllowFrom, DEFAULT_ACCOUNT_ID, formatDocsLink } from "mayros/plugin-sdk";
...
function setFeishuDmPolicy(cfg: MayrosConfig, dmPolicy: DmPolicy): MayrosConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: MayrosConfig, allowFrom: string[]): MayrosConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: MayrosConfig, groupAllowFrom: string[]): MayrosConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
