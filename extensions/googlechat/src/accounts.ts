...
export function listGoogleChatAccountIds(cfg: MayrosConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: MayrosConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: MayrosConfig): ResolvedGoogleChatAccount[] {
