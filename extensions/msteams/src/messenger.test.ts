...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "mayros/plugin-sdk";
...
import { resolvePreferredMayrosTmpDir } from "../../../src/infra/tmp-mayros-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredMayrosTmpDir(), "msteams-mention-"));
