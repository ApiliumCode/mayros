...
export function listZalouserAccountIds(cfg: MayrosConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: MayrosConfig): string {
...
function mergeZalouserAccountConfig(cfg: MayrosConfig, accountId: string): ZalouserAccountConfig {
