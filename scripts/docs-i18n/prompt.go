...
- Keep product names in English: Mayros, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Mayros Gateway, use “Gateway 网关”.
