...
# Output:
# - dist/Mayros.app
# - dist/Mayros-<version>.zip
# - dist/Mayros-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.mayros.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Mayros.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Mayros-$VERSION.zip"
DMG="$ROOT_DIR/dist/Mayros-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Mayros-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Mayros-$VERSION.dSYM.zip"
