...
if [[ -z "$version_content" ]]; then
  echo "<h2>Mayros $VERSION</h2>"
  echo "<p>Latest Mayros update.</p>"
  echo "<p><a href=\"https://github.com/ApiliumCode/mayros/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
