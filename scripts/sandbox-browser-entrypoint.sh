...
export DISPLAY=:1
export HOME=/tmp/mayros-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${MAYROS_BROWSER_CDP_PORT:-${MAYROS_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${MAYROS_BROWSER_CDP_SOURCE_RANGE:-${MAYROS_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${MAYROS_BROWSER_VNC_PORT:-${MAYROS_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${MAYROS_BROWSER_NOVNC_PORT:-${MAYROS_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${MAYROS_BROWSER_ENABLE_NOVNC:-${MAYROS_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${MAYROS_BROWSER_HEADLESS:-${MAYROS_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${MAYROS_BROWSER_NO_SANDBOX:-${MAYROS_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${MAYROS_BROWSER_NOVNC_PASSWORD:-${MAYROS_BROWSER_NOVNC_PASSWORD:-}}"
