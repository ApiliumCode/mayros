...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.mayros.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", MAYROS_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://apilium.com/us/doc/mayros/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when MAYROS_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.mayros.gateway.plist",
    },
    {
      name: "uses profile-specific label when MAYROS_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", MAYROS_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.mayros.jbphoenix.plist",
    },
    {
      name: "prefers MAYROS_LAUNCHD_LABEL over MAYROS_PROFILE",
      env: {
        HOME: "/Users/test",
        MAYROS_PROFILE: "jbphoenix",
        MAYROS_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from MAYROS_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        MAYROS_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty MAYROS_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        MAYROS_PROFILE: "myprofile",
        MAYROS_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.mayros.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
