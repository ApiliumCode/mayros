...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.MAYROS_STATE_DIR;
  const configPath = env.MAYROS_CONFIG_PATH;
  ...
  return {
    ...
    MAYROS_PROFILE: profile,
    MAYROS_STATE_DIR: stateDir,
    MAYROS_CONFIG_PATH: configPath,
    MAYROS_GATEWAY_PORT: String(port),
    MAYROS_GATEWAY_TOKEN: token,
    MAYROS_LAUNCHD_LABEL: resolvedLaunchdLabel,
    MAYROS_SYSTEMD_UNIT: systemdUnit,
    MAYROS_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    MAYROS_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    MAYROS_STATE_DIR: stateDir,
    MAYROS_CONFIG_PATH: configPath,
    MAYROS_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    MAYROS_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    MAYROS_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    MAYROS_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    MAYROS_LOG_PREFIX: "node",
    MAYROS_SERVICE_MARKER: NODE_SERVICE_MARKER,
    MAYROS_SERVICE_KIND: NODE_SERVICE_KIND,
    MAYROS_SERVICE_VERSION: VERSION,
  };
}
