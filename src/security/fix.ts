...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MayrosConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MayrosConfig; env: NodeJS.ProcessEnv }): {
  cfg: MayrosConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
