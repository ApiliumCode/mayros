...
describe("isHeartbeatContentEffectivelyEmpty", () => {
  ...
  it("returns true for header-only content", () => {
    expect(isHeartbeatContentEffectivelyEmpty("# HOPE.md")).toBe(true);
    expect(isHeartbeatContentEffectivelyEmpty("# HOPE.md\n")).toBe(true);
    expect(isHeartbeatContentEffectivelyEmpty("# HOPE.md\n\n")).toBe(true);
  });
