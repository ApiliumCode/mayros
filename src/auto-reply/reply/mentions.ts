...
function resolveMentionPatterns(cfg: MayrosConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: MayrosConfig | undefined, agentId?: string): RegExp[] {
