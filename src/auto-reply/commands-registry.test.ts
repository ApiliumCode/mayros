...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@mayros", { botUsername: "mayros" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@mayros args", {
        botUsername: "mayros",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "mayros" })).toBe(
      "/help@otherbot",
    );
  });
