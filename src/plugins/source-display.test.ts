...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/mayros/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/mayros/extensions",
        global: "/Users/x/.mayros/extensions",
        workspace: "/Users/x/ws/.mayros/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.mayros/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/mayros/extensions",
        global: "/Users/x/.mayros/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.mayros/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/mayros/extensions",
        global: "/Users/x/.mayros/extensions",
