...
export type MayrosPluginConfigSchema = {
...
export type MayrosPluginToolContext = {
  config?: MayrosConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type MayrosPluginToolFactory = (
  ctx: MayrosPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type MayrosPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type MayrosPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<MayrosConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type MayrosPluginGatewayMethod = {
  method: string;
 ...
 */
export type MayrosPluginCommandDefinition = {
...
export type MayrosPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type MayrosPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type MayrosPluginCliContext = {
  program: Command;
  config: MayrosConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type MayrosPluginCliRegistrar = (ctx: MayrosPluginCliContext) => void | Promise<void>;

export type MayrosPluginServiceContext = {
  config: MayrosConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type MayrosPluginService = {
  id: string;
  start: (ctx: MayrosPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: MayrosPluginServiceContext) => void | Promise<void>;
};

export type MayrosPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type MayrosPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: MayrosPluginConfigSchema;
  register?: (api: MayrosPluginApi) => void | Promise<void>;
  activate?: (api: MayrosPluginApi) => void | Promise<void>;
};

export type MayrosPluginModule =
  | MayrosPluginDefinition
  | ((api: MayrosPluginApi) => void | Promise<void>);

export type MayrosPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  registerHook: (
    ...
    opts?: MayrosPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: MayrosPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: MayrosPluginHttpRouteHandler }) => void;
  registerChannel: (registration: MayrosPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: MayrosPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: MayrosPluginService) => void;
   ...
   */
  registerCommand: (command: MayrosPluginCommandDefinition) => void;
