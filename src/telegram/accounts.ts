...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MAYROS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: MayrosConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: MayrosConfig): string {
...
function mergeTelegramAccountConfig(cfg: MayrosConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: MayrosConfig): ResolvedTelegramAccount[] {
