...
export function listWhatsAppAuthDirs(cfg: MayrosConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MayrosConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MayrosConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MayrosConfig): ResolvedWhatsAppAccount[] {
