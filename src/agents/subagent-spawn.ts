...
/** Semantic context injected by the agent-mesh plugin during delegation. */
export type DelegationSemanticContext = {
  task: string;
  parentAgentId: string;
  relevantTriples: Array<{ subject: string; predicate: string; object: string }>;
...
export type SpawnSubagentParams = {
  ...
  /** Optional semantic context from the agent-mesh plugin for knowledge-aware delegation. */
  semanticContext?: DelegationSemanticContext;
};
