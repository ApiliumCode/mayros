...
function resolveAvatarSource(cfg: MayrosConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MayrosConfig, agentId: string): AgentAvatarResolution {
