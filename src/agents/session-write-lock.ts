...
const CLEANUP_STATE_KEY = Symbol.for("mayros.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("mayros.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("mayros.sessionWriteLockWatchdogState");
