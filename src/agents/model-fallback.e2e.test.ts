...
function makeCfg(overrides: Partial<MayrosConfig> = {}): MayrosConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): MayrosConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): MayrosConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
