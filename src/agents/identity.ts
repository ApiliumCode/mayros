import type { MayrosConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: MayrosConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: MayrosConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[mayros]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: MayrosConfig, channel: string): Record<string, unknown> | undefined {
