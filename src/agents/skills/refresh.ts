...
function resolveWatchPaths(workspaceDir: string, config?: MayrosConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MayrosConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MayrosConfig }) {
