...
function resolveAdaptiveReadMaxBytes(options?: MayrosReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMayrosReadTool(base, {
...
export function createMayrosReadTool(
  base: AnyAgentTool,
  options?: MayrosReadToolOptions,
): AnyAgentTool {
