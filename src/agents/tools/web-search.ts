...
type WebSearchConfig = NonNullable<MayrosConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: MayrosConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("mayros configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://apilium.com/us/doc/mayros/tools/web",
  };
}
...
async function runPerplexitySearch(params: {
  ...
  const res = await fetch(endpoint, {
    ...
    headers: {
      ...
      "HTTP-Referer": "https://apilium.com/us/products/mayros",
      "X-Title": "Mayros Web Search",
    },
