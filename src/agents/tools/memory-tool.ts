...
function resolveMemoryToolContext(options: { config?: MayrosConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: MayrosConfig): MemoryCitationsMode {
