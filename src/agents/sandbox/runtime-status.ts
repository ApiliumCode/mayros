...
function resolveMainSessionKeyForSandbox(params: { cfg?: MayrosConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: MayrosConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`mayros sandbox explain --session ${runtime.sessionKey}`)}`,
  );
