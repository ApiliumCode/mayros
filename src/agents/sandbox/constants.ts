...
export const DEFAULT_SANDBOX_IMAGE = "mayros-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "mayros-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "mayros-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "mayros-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "mayros-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "mayros-sandbox-browser";
