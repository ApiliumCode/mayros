...
describe("agent components", () => {
  const createCfg = (): MayrosConfig => ({}) as MayrosConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp/mayros-sessions-test.json");
  });
