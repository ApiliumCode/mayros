...
function mergeDiscordAccountConfig(cfg: MayrosConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: MayrosConfig): ResolvedDiscordAccount[] {
