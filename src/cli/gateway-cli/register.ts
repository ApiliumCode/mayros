      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["mayros gateway run", "Run the gateway in the foreground."],
            ["mayros gateway status", "Show service status and probe reachability."],
            ["mayros gateway discover", "Find local and wide-area gateway beacons."],
            ["mayros gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "apilium.com/us/doc/mayros/cli/gateway")}\n`,
      ),
  );
