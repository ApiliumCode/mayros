...
const SANDBOX_EXAMPLES = {
  main: [
    ["mayros sandbox list", "List all sandbox containers."],
    ["mayros sandbox list --browser", "List only browser containers."],
    ["mayros sandbox recreate --all", "Recreate all containers."],
    ["mayros sandbox recreate --session main", "Recreate a specific session."],
    ["mayros sandbox recreate --agent mybot", "Recreate agent containers."],
    ["mayros sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["mayros sandbox list", "List all sandbox containers."],
    ["mayros sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["mayros sandbox recreate --all", "Recreate all containers."],
    ["mayros sandbox recreate --session main", "Recreate a specific session."],
    ["mayros sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["mayros sandbox recreate --browser --all", "Recreate only browser containers."],
    ["mayros sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["mayros sandbox explain", "Show effective sandbox config."],
    ["mayros sandbox explain --session agent:main:main", "Explain a specific session."],
    ["mayros sandbox explain --agent work", "Explain an agent sandbox."],
    ["mayros sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "apilium.com/us/doc/mayros/cli/sandbox")}\n`,
    )
    .action(() => {
