const DEFAULT_TAGLINE = "All your chats, one Mayros.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little bot-anist is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  ...
  "Systems up, commit in—let's ship something mildly responsible.",
  "I'll streamline your workflow like a precision engine: fast, clean, effective.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.MAYROS_TAGLINE_INDEX;
