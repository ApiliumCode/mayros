    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mayros directory self --channel slack", "Show the connected account identity."],
          [
            'mayros directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["mayros directory groups list --channel discord", "List available groups/channels."],
          [
            "mayros directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "apilium.com/us/doc/mayros/cli/directory",
        )}\n`,
    )
    .action(() => {
