...
${formatHelpExamples([
  ['mayros message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'mayros message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'mayros message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "apilium.com/us/doc/mayros/cli/message")}`,
    )
    .action(() => {
