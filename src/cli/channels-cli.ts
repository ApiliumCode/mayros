    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["mayros channels list", "List configured channels and auth profiles."],
          ["mayros channels status --probe", "Run channel status checks and probes."],
          [
            "mayros channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["mayros channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "apilium.com/us/doc/mayros/cli/channels",
        )}\n`,
    );
