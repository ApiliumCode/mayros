...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/ApiliumCode/mayros/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.MAYROS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.mayros/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: MayrosConfig = {
    ...params.cfg,
