...
import { type MayrosConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: MayrosConfig): string[] {
...
export function listAgentsForGateway(cfg: MayrosConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MayrosConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: MayrosConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: MayrosConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: MayrosConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: MayrosConfig): GatewaySessionsDefaults {
