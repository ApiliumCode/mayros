...
import { createMayrosTools } from "../agents/mayros-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(getHeader(req, "x-mayros-message-channel") ?? "");
  const accountId = getHeader(req, "x-mayros-account-id")?.trim() || undefined;
  ...
  const allTools = createMayrosTools({
