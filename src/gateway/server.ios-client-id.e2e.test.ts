...
beforeAll(async () => {
  previousToken = process.env.MAYROS_GATEWAY_TOKEN;
  process.env.MAYROS_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "mayros-ios", platform: "ios" },
  { clientId: "mayros-android", platform: "android" },
