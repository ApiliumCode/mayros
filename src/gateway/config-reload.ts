...
import type { MayrosConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: MayrosConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: MayrosConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: MayrosConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: MayrosConfig) => void;
  log: {
