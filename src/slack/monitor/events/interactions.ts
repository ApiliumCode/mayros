...
// Prefix for Mayros-generated action IDs to scope our handler
const MAYROS_ACTION_PREFIX = "mayros:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Mayros modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${MAYROS_ACTION_PREFIX}`),
