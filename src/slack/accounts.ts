...
function mergeSlackAccountConfig(cfg: MayrosConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MayrosConfig): ResolvedSlackAccount[] {
