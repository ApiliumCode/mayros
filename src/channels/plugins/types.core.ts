...
export type ChannelAgentToolFactory = (params: { cfg?: MayrosConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MayrosConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MayrosConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MayrosConfig }) => boolean;
  supportsCards?: (params: { cfg: MayrosConfig }) => boolean;
