...
function setSlackDmPolicy(cfg: MayrosConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Mayros";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Mayros`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: MayrosConfig, allowFrom: string[]): MayrosConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
