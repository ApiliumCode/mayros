...
function mergeSignalAccountConfig(cfg: MayrosConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MayrosConfig): ResolvedSignalAccount[] {
