...
export const A2UI_PATH = "/__mayros__/a2ui";

export const CANVAS_HOST_PATH = "/__mayros__/canvas";

export const CANVAS_WS_PATH = "/__mayros__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.mayrosCanvasA2UIAction.postMessage(...)
  // - Android: window.mayrosCanvasA2UIAction.postMessage(...)
  const handlerNames = ["mayrosCanvasA2UIAction"];
  ...
  globalThis.Mayros = globalThis.Mayros ?? {};
  globalThis.Mayros.postMessage = postToNode;
  globalThis.Mayros.sendUserAction = sendUserAction;
  globalThis.mayrosPostMessage = postToNode;
  globalThis.mayrosSendUserAction = sendUserAction;
