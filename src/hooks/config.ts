import type { MayrosConfig, HookConfig } from "../config/config.js";
import {
...
export function isConfigPathTruthy(config: MayrosConfig | undefined, pathStr: string): boolean {
  return isConfigPathTruthyWithDefaults(config, pathStr, DEFAULT_CONFIG_VALUES);
}

export function resolveHookConfig(
  config: MayrosConfig | undefined,
  hookKey: string,
...
export function shouldIncludeHook(params: {
  ...
  const pluginManaged = entry.hook.source === "mayros-plugin";
