...
homepage: https://apilium.com/us/doc/mayros/automation/hooks#bootstrap-extra-files
metadata:
  {
    "mayros":
      {
...
Only recognized bootstrap basenames are loaded (`AGENTS.md`, `MAYROS.md`, `TOOLS.md`,
