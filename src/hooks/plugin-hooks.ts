...
import type { MayrosPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: MayrosPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: MayrosPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
