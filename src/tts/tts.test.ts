...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.MAYROS_TTS_PREFS;
      process.env.MAYROS_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.MAYROS_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: MayrosConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
