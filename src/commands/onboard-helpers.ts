...
export function summarizeExistingConfig(config: MayrosConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://apilium.com/us/doc/mayros/gateway/remote",
    "https://apilium.com/us/doc/mayros/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
