...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://apilium.com/us/doc/mayros/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("mayros hooks list")}`,
      `  ${formatCliCommand("mayros hooks enable <name>")}`,
      `  ${formatCliCommand("mayros hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
