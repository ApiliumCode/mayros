...
export function applyVercelAiGatewayProviderConfig(cfg: MayrosConfig): MayrosConfig {
...
export function applyVercelAiGatewayConfig(cfg: MayrosConfig): MayrosConfig {
