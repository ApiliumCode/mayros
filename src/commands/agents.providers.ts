...
function resolveDefaultAccountId(cfg: MayrosConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: MayrosConfig): boolean {
...
export function summarizeBindings(cfg: MayrosConfig, bindings: AgentBinding[]): string[] {
