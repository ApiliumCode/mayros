...
type PromptDefaultModelResult = { model?: string; config?: MayrosConfig };
...
function resolveConfiguredModelRaw(cfg: MayrosConfig): string {
...
function resolveConfiguredModelKeys(cfg: MayrosConfig): string[] {
...
export function applyPrimaryModel(cfg: MayrosConfig, model: string): MayrosConfig {
...
export function applyModelAllowlist(cfg: MayrosConfig, models: string[]): MayrosConfig {
  const defaults = cfg.agents?.defaults;
