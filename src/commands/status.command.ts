...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Mayros status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("mayros security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("mayros security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://apilium.com/us/doc/mayros/faq");
  runtime.log("Troubleshooting: https://apilium.com/us/doc/mayros/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("mayros status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("mayros logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("mayros status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("mayros gateway probe")}`);
  }
}
