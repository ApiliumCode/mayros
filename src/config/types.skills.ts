...
export type SkillsSemanticConfig = {
  /** Enable semantic skill runtime. */
  enabled?: boolean;
  /** Require Ed25519 signatures for Hub-installed skills. */
  requireSignedHubSkills?: boolean;
  /** Validate assertions against Cortex PoL rules. */
...
export type SkillsConfig = {
  ...
  /** Semantic skills configuration. */
  semantic?: SkillsSemanticConfig;
};
