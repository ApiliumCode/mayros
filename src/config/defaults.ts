...
function resolveAnthropicDefaultAuthMode(cfg: MayrosConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MayrosConfig): MayrosConfig {
...
export function applyTalkApiKey(config: MayrosConfig): MayrosConfig {
...
export function applyModelDefaults(cfg: MayrosConfig): MayrosConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MayrosConfig): MayrosConfig {
...
export function applyLoggingDefaults(cfg: MayrosConfig): MayrosConfig {
...
export function applyContextPruningDefaults(cfg: MayrosConfig): MayrosConfig {
...
export function applyCompactionDefaults(cfg: MayrosConfig): MayrosConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
