...
function isTelegramConfigured(cfg: MayrosConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: MayrosConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: MayrosConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: MayrosConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: MayrosConfig): boolean {
...
function isIMessageConfigured(cfg: MayrosConfig): boolean {
...
function isWhatsAppConfigured(cfg: MayrosConfig): boolean {
...
function isGenericChannelConfigured(cfg: MayrosConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: MayrosConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: MayrosConfig, providerId: string): boolean {
...
function resolveConfiguredPlugins(cfg: MayrosConfig, env: NodeJS.ProcessEnv): PluginEnableChange[] {
...
function isPluginExplicitlyDisabled(cfg: MayrosConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: MayrosConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: MayrosConfig, pluginId: string): MayrosConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
