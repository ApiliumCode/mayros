...
const execHostEnforced = process.env.MAYROS_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.MAYROS_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
